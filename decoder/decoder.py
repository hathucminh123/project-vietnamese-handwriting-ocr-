...
class GreedySearchDecoder(nn.Module):
    ...
    def forward(self, probs):
        ...
        # Check if indices is 0-dimensional
        if indices.dim() < 1:
            # Handle the case where indices is 0-dimensional
            # For example, you could return an empty list or raise an error
            print("indices is 0-dimensional")  # Print a message if indices is 0-dimensional
            return []
